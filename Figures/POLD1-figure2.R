...
df_wt$SBS5_mut = df_wt$SBS5 * df_wt$N_mut_all
df_wt$SBS10c_mut = df_wt$SBS10c * df_wt$N_mut_all
N_mut_wt = mean(df_wt$N_mut_all)
N_SBS5_wt = mean(df_wt$SBS5_mut)
N_SBS10c_wt = mean(df_wt$SBS10c_mut)

df_L474P$SBS5_mut = df_L474P$SBS5 * df_L474P$N_mut_all
df_L474P$SBS10c_mut = df_L474P$SBS10c * df_L474P$N_mut_all
df_L474P_SBS5 = df_L474P[,c(1,13)]
colnames(df_L474P_SBS5) = c("Sample", "N_mut")
df_L474P_SBS5$Type = "SBS5"
df_L474P_SBS5$wt_value = N_SBS5_wt

df_L474P_SBS10c = df_L474P[,c(1,14)]
