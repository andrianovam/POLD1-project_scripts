...
tiff(filename="Output_plots/Figure4ñ_crypts_tumors_somatic_signatures.tiff", width=10, height=6, res=300, units='cm')
...
(ggplot(df_for_plot, aes(x=Pos, y=Value))
  ...
  +ggtitle("POLD1 L474P Hypermutable colon cancer")
  +theme(legend.position='none')
  +theme(axis.text=element_text(size=8),axis.title=element_text(size=10),legend.text=element_text(size=8),legend.title=element_text(size=10),title =element_text(size=8))
